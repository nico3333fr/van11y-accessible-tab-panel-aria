...
;(function (doc) {
  ...
  var unSelectLinks = function unSelectLinks(elts) {
    elts.forEach(function (link_node, index) {
      var _setAttributes;
  ...
  var unSelectContents = function unSelectContents(elts) {
    elts.forEach(function (content_node, index) {
  ...
  var onLoad = function onLoad() {
    ...
    $listTabs().forEach(function (tabs_node, index) {
      ...
      // ul
      $tabList.forEach(function (tabList, index) {
        var _setAttributes3;
      ...
      // a
      $tabListLinks.forEach(function (tabListLink, index) {
        ...
        setAttributes(tabListLink, (_setAttributes5 = {}, _defineProperty(_setAttributes5, 'id', TABS_PREFIX_IDS + idHref), _defineProperty(_setAttributes5, ATTR_ROLE, TABS_ROLE_TAB), _defineProperty(_setAttributes5, ATTR_CONTROLS, idHref), _defineProperty(_setAttributes5, 'tabindex', '-1'), _defineProperty(_setAttributes5, ATTR_SELECTED, 'false'), _setAttributes5));
